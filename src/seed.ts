...
async function main() {
  ...
  const products: { name: string; desc: string; price: number; unit: string; cat: string; bonus: number; comp?: string; mult?: number }[] = [
    ...
    // ─── Лист оцинкованный (ГОСТ 14918-2020) ────────────────
    { name: 'Лист оцинк. 0.25мм 1000x2000', desc: 'Сталь оцинкованная 0.25мм, 1000x2000, сорт 1, ГОСТ 14918-2020', price: 215000, unit: 'тонна', cat: 'list-ocink', bonus: 4, comp: 'Ст08пс' },
    { name: 'Лист оцинк. 0.30мм 1000x2000', desc: 'Сталь оцинкованная 0.30мм, 1000x2000, сорт 1, ГОСТ 14918-2020', price: 210000, unit: 'тонна', cat: 'list-ocink', bonus: 4, comp: 'Ст08пс' },
    { name: 'Лист оцинк. 0.35мм 1250x2500', desc: 'Сталь оцинкованная 0.35мм, 1250x2500, сорт 1, ГОСТ 14918-2020', price: 205000, unit: 'тонна', cat: 'list-ocink', bonus: 4, comp: 'Ст08пс' },
    { name: 'Лист оцинк. 0.40мм 1250x2500', desc: 'Сталь оцинкованная 0.40мм, 1250x2500, сорт 1, ГОСТ 14918-2020', price: 200000, unit: 'тонна', cat: 'list-ocink', bonus: 4, comp: 'Ст08пс' },
    { name: 'Лист оцинк. 0.45мм 1250x2500', desc: 'Сталь оцинкованная 0.45мм, 1250x2500, сорт 1, ГОСТ 14918-2020', price: 198000, unit: 'тонна', cat: 'list-ocink', bonus: 4, comp: 'Ст08пс' },
    { name: 'Лист оцинк. 0.55мм 1250x2500', desc: 'Сталь оцинкованная 0.55мм, 1250x2500, сорт 1, ГОСТ 14918-2020', price: 194000, unit: 'тонна', cat: 'list-ocink', bonus: 4, comp: 'Ст08пс' },
    { name: 'Лист оцинк. 0.65мм 1250x2500', desc: 'Сталь оцинкованная 0.65мм, 1250x2500, сорт 1, ГОСТ 14918-2020', price: 192000, unit: 'тонна', cat: 'list-ocink', bonus: 4, comp: 'Ст08пс' },
    { name: 'Лист оцинк. 0.70мм 1250x2500', desc: 'Сталь оцинкованная 0.70мм, 1250x2500, сорт 1, ГОСТ 14918-2020', price: 190000, unit: 'тонна', cat: 'list-ocink', bonus: 4, comp: 'Ст08пс' },

    // ─── Лист рифлёный (ГОСТ 8568-77) ───────────────────────
    { name: 'Лист рифлёный 3мм 1250x2500', desc: 'Лист горячекатаный с рифлением (чечевица), 3мм, 1250x2500, ГОСТ 8568-77', price: 162000, unit: 'тонна', cat: 'list-rifl', bonus: 4, comp: 'Ст3сп/пс' },
    { name: 'Лист рифлёный 3мм 1500x6000', desc: 'Лист горячекатаный с рифлением (чечевица), 3мм, 1500x6000, ГОСТ 8568-77', price: 160000, unit: 'тонна', cat: 'list-rifl', bonus: 4, comp: 'Ст3сп/пс' },
    { name: 'Лист рифлёный 4мм 1500x6000', desc: 'Лист горячекатаный с рифлением (чечевица), 4мм, 1500x6000, ГОСТ 8568-77', price: 157000, unit: 'тонна', cat: 'list-rifl', bonus: 4, comp: 'Ст3сп/пс' },
    { name: 'Лист рифлёный 5мм 1500x6000', desc: 'Лист горячекатаный с рифлением (чечевица), 5мм, 1500x6000, ГОСТ 8568-77', price: 155000, unit: 'тонна', cat: 'list-rifl', bonus: 4, comp: 'Ст3сп/пс' },

    // ─── Лист холоднокатаный (ГОСТ 19904-90) ─────────────────
    { name: 'Лист х/к 0.5мм 1000x2000', desc: 'Лист холоднокатаный 0.5мм, 1000x2000, ГОСТ 16523-97, ГОСТ 19904-90', price: 195000, unit: 'тонна', cat: 'list-hk', bonus: 4, comp: 'Ст08кп/пс' },
    { name: 'Лист х/к 0.5мм 1250x2500', desc: 'Лист холоднокатаный 0.5мм, 1250x2500, ГОСТ 16523-97, ГОСТ 19904-90', price: 193000, unit: 'тонна', cat: 'list-hk', bonus: 4, comp: 'Ст08кп/пс' },
    { name: 'Лист х/к 0.7мм 1000x2000', desc: 'Лист холоднокатаный 0.7мм, 1000x2000, ГОСТ 16523-97, ГОСТ 19904-90', price: 188000, unit: 'тонна', cat: 'list-hk', bonus: 4, comp: 'Ст08кп/пс' },
    { name: 'Лист х/к 0.7мм 1250x2500', desc: 'Лист холоднокатаный 0.7мм, 1250x2500, ГОСТ 16523-97, ГОСТ 19904-90', price: 186000, unit: 'тонна', cat: 'list-hk', bonus: 4, comp: 'Ст08кп/пс' },
    { name: 'Лист х/к 0.8мм 1250x2500', desc: 'Лист холоднокатаный 0.8мм, 1250x2500, ГОСТ 16523-97, ГОСТ 19904-90', price: 183000, unit: 'тонна', cat: 'list-hk', bonus: 4, comp: 'Ст08кп/пс' },
    { name: 'Лист х/к 1.0мм 1000x2000', desc: 'Лист холоднокатаный 1.0мм, 1000x2000, ГОСТ 16523-97, ГОСТ 1050-2013', price: 180000, unit: 'тонна', cat: 'list-hk', bonus: 4, comp: 'Ст08кп/пс' },
    { name: 'Лист х/к 1.2мм 1250x2500', desc: 'Лист холоднокатаный 1.2мм, 1250x2500, ГОСТ 16523-97, ГОСТ 1050-2013', price: 176000, unit: 'тонна', cat: 'list-hk', bonus: 4, comp: 'Ст08кп/пс' },

    // ─── Лист ПВЛ (просечно-вытяжной) ───────────────────────
    { name: 'Лист ПВЛ-306 3мм 1200x2000', desc: 'Просечно-вытяжной лист ПВЛ-306, 3мм, 1200x2000мм, ГОСТ 8706-78', price: 175000, unit: 'тонна', cat: 'list-pvl', bonus: 4, comp: 'Ст3' },
    { name: 'Лист ПВЛ-306 3мм 1500x3000', desc: 'Просечно-вытяжной лист ПВЛ-306, 3мм, 1500x3000мм, ГОСТ 8706-78', price: 173000, unit: 'тонна', cat: 'list-pvl', bonus: 4, comp: 'Ст3' },
    { name: 'Лист ПВЛ-406 4мм 1500x3000', desc: 'Просечно-вытяжной лист ПВЛ-406, 4мм, 1500x3000мм, ГОСТ 8706-78', price: 170000, unit: 'тонна', cat: 'list-pvl', bonus: 4, comp: 'Ст3' },
    { name: 'Лист ПВЛ-408 4мм 1500x2500', desc: 'Просечно-вытяжной лист ПВЛ-408, 4мм, 1500x2500мм, ГОСТ 8706-78', price: 168000, unit: 'тонна', cat: 'list-pvl', bonus: 4, comp: 'Ст3' },
    { name: 'Лист ПВЛ-506 5мм 1500x3300', desc: 'Просечно-вытяжной лист ПВЛ-506, 5мм, 1500x3300мм, ГОСТ 8706-78', price: 165000, unit: 'тонна', cat: 'list-pvl', bonus: 4, comp: 'Ст3' },

    // ─── Профнастил (ГОСТ 24045-2016) ────────────────────────
    { name: 'Профнастил С15 0.40мм окраш.', desc: 'Профлист оцинкованный с полимерным покрытием С15, 0.40мм, 1180x6000, ГОСТ 24045-2016', price: 2600, unit: 'м.п.', cat: 'profnastil', bonus: 4 },
    { name: 'Профнастил С15 0.45мм окраш.', desc: 'Профлист оцинкованный с полимерным покрытием С15, 0.45мм, 1180x6000, ГОСТ 24045-2016', price: 2900, unit: 'м.п.', cat: 'profnastil', bonus: 4 },
    { name: 'Профнастил С15 0.50мм окраш.', desc: 'Профлист оцинкованный с полимерным покрытием С15, 0.50мм, 1180x6000, ГОСТ 24045-2016', price: 3100, unit: 'м.п.', cat: 'profnastil', bonus: 4 },
    { name: 'Профнастил С16 0.40мм окраш.', desc: 'Профлист оцинкованный с полимерным покрытием С16, 0.40мм, 1050x6000, ГОСТ 24045-2016', price: 2700, unit: 'м.п.', cat: 'profnastil', bonus: 4 },
    { name: 'Профнастил С16 0.45мм окраш.', desc: 'Профлист оцинкованный с полимерным покрытием С16, 0.45мм, 1050x6000, ГОСТ 24045-2016', price: 3000, unit: 'м.п.', cat: 'profnastil', bonus: 4 },
    { name: 'Профнастил НС35 0.50мм оцинк.', desc: 'Профнастил НС35-1000 оцинкованный, 0.50мм, ГОСТ 24045-2016', price: 2500, unit: 'м.п.', cat: 'profnastil', bonus: 4 },

    // ─── Квадрат (ГОСТ 2591-2006) ────────────────────────────
    { name: 'Квадрат 10x10 Ст20', desc: 'Квадрат стальной горячекатаный 10x10мм, ГОСТ 2591-2006', price: 145000, unit: 'тонна', cat: 'kvadrat', bonus: 3, comp: 'Ст20' },
    { name: 'Квадрат 12x12 Ст20', desc: 'Квадрат стальной горячекатаный 12x12мм, ГОСТ 2591-2006', price: 142000, unit: 'тонна', cat: 'kvadrat', bonus: 3, comp: 'Ст20' },
    { name: 'Квадрат 14x14 Ст45', desc: 'Квадрат стальной горячекатаный 14x14мм, ГОСТ 2591-2006', price: 148000, unit: 'тонна', cat: 'kvadrat', bonus: 3, comp: 'Ст45' },
    { name: 'Квадрат 16x16 Ст20', desc: 'Квадрат стальной горячекатаный 16x16мм, ГОСТ 2591-2006', price: 140000, unit: 'тонна', cat: 'kvadrat', bonus: 3, comp: 'Ст20' },
    { name: 'Квадрат 20x20 Ст45', desc: 'Квадрат стальной горячекатаный 20x20мм, ГОСТ 2591-2006', price: 146000, unit: 'тонна', cat: 'kvadrat', bonus: 3, comp: 'Ст45' },
    { name: 'Квадрат 25x25 Ст20', desc: 'Квадрат стальной горячекатаный 25x25мм, ГОСТ 2591-2006', price: 138000, unit: 'тонна', cat: 'kvadrat', bonus: 3, comp: 'Ст20' },

    // ─── Полоса стальная (ГОСТ 103-2006) ─────────────────────
    { name: 'Полоса 25x4 Ст3', desc: 'Полоса стальная горячекатаная 25x4мм, ГОСТ 103-2006, ГОСТ 535-2005', price: 135000, unit: 'тонна', cat: 'polosa', bonus: 3, comp: 'Ст3сп/пс' },
    { name: 'Полоса 40x4 Ст3', desc: 'Полоса стальная горячекатаная 40x4мм, ГОСТ 103-2006', price: 133000, unit: 'тонна', cat: 'polosa', bonus: 3, comp: 'Ст3сп/пс' },
    { name: 'Полоса 50x5 Ст3', desc: 'Полоса стальная горячекатаная 50x5мм, ГОСТ 103-2006', price: 130000, unit: 'тонна', cat: 'polosa', bonus: 3, comp: 'Ст3сп/пс' },
    { name: 'Полоса 60x6 Ст3', desc: 'Полоса стальная горячекатаная 60x6мм, ГОСТ 103-2006', price: 128000, unit: 'тонна', cat: 'polosa', bonus: 3, comp: 'Ст3сп/пс' },
    { name: 'Полоса 80x8 Ст3', desc: 'Полоса стальная горячекатаная 80x8мм, ГОСТ 103-2006', price: 127000, unit: 'тонна', cat: 'polosa', bonus: 3, comp: 'Ст3сп/пс' },

    // ─── Шестигранник (ГОСТ 2879-2006) ───────────────────────
    { name: 'Шестигранник 10 Ст20', desc: 'Шестигранник стальной горячекатаный 10мм, ГОСТ 2879-2006', price: 155000, unit: 'тонна', cat: 'shestigrannik', bonus: 3, comp: 'Ст20' },
    { name: 'Шестигранник 14 Ст45', desc: 'Шестигранник стальной горячекатаный 14мм, ГОСТ 2879-2006', price: 152000, unit: 'тонна', cat: 'shestigrannik', bonus: 3, comp: 'Ст45' },
    { name: 'Шестигранник 17 Ст45', desc: 'Шестигранник стальной горячекатаный 17мм, ГОСТ 2879-2006', price: 150000, unit: 'тонна', cat: 'shestigrannik', bonus: 3, comp: 'Ст45' },
    { name: 'Шестигранник 22 Ст35', desc: 'Шестигранник стальной горячекатаный 22мм, ГОСТ 2879-2006', price: 148000, unit: 'тонна', cat: 'shestigrannik', bonus: 3, comp: 'Ст35' },
    { name: 'Шестигранник 27 Ст35', desc: 'Шестигранник стальной горячекатаный 27мм, ГОСТ 2879-2006', price: 146000, unit: 'тонна', cat: 'shestigrannik', bonus: 3, comp: 'Ст35' },

    // ─── Труба электросварная (ГОСТ 10704-91) ────────────────
    { name: 'Труба э/с 57x3 Ст3', desc: 'Труба стальная электросварная 57x3мм, ГОСТ 10704-91', price: 178000, unit: 'тонна', cat: 'truba-esv', bonus: 5, comp: 'Ст3пс' },
    { name: 'Труба э/с 57x3.5 Ст20', desc: 'Труба стальная электросварная 57x3.5мм, ГОСТ 10704-91, ГОСТ 10705-80', price: 182000, unit: 'тонна', cat: 'truba-esv', bonus: 5, comp: 'Ст20' },
    { name: 'Труба э/с 76x3 Ст10', desc: 'Труба стальная электросварная 76x3мм, ГОСТ 10704-91, ГОСТ 10705-80', price: 176000, unit: 'тонна', cat: 'truba-esv', bonus: 5, comp: 'Ст10' },
    { name: 'Труба э/с 76x3.5 Ст3', desc: 'Труба стальная электросварная 76x3.5мм, ГОСТ 10704-91', price: 175000, unit: 'тонна', cat: 'truba-esv', bonus: 5, comp: 'Ст3пс' },
    { name: 'Труба э/с 89x3.5 Ст3', desc: 'Труба стальная электросварная 89x3.5мм, ГОСТ 10704-91', price: 174000, unit: 'тонна', cat: 'truba-esv', bonus: 5, comp: 'Ст3пс' },
    { name: 'Труба э/с 108x4 Ст3', desc: 'Труба стальная электросварная 108x4мм, ГОСТ 10704-91', price: 173000, unit: 'тонна', cat: 'truba-esv', bonus: 5, comp: 'Ст3пс' },
    { name: 'Труба э/с 159x4.5 Ст3', desc: 'Труба стальная электросварная 159x4.5мм, ГОСТ 10704-91', price: 172000, unit: 'тонна', cat: 'truba-esv', bonus: 5, comp: 'Ст3пс' },

    // ─── Труба НКТ (ГОСТ 633-80) ─────────────────────────────
    { name: 'Труба НКТ 60x5 гр. Д', desc: 'Труба насосно-компрессорная 60x5мм, группа Д, ГОСТ 633-80', price: 245000, unit: 'тонна', cat: 'truba-nkt', bonus: 5, comp: 'группа Д' },
    { name: 'Труба НКТ 73x5.5 гр. Д', desc: 'Труба насосно-компрессорная 73x5.5мм, группа Д, ГОСТ 633-80', price: 240000, unit: 'тонна', cat: 'truba-nkt', bonus: 5, comp: 'группа Д' },
    { name: 'Труба НКТ 89x6.5 гр. К', desc: 'Труба насосно-компрессорная 89x6.5мм, группа К, ГОСТ 633-80', price: 250000, unit: 'тонна', cat: 'truba-nkt', bonus: 5, comp: 'группа К' },
    { name: 'Труба НКТ 102x6.5 гр. Л', desc: 'Труба насосно-компрессорная 102x6.5мм, группа Л, ГОСТ 633-80', price: 248000, unit: 'тонна', cat: 'truba-nkt', bonus: 5, comp: 'группа Л' },
    { name: 'Труба НКТ 114x7 гр. М', desc: 'Труба насосно-компрессорная 114x7мм, группа М, ГОСТ 633-80', price: 255000, unit: 'тонна', cat: 'truba-nkt', bonus: 5, comp: 'группа М' },

    // ─── Уголок неравнополочный (ГОСТ 8510-93) ───────────────
    { name: 'Уголок неравноп. 63x40x5', desc: 'Уголок стальной неравнополочный 63x40x5мм, ГОСТ 8510-93, длина 6-12м', price: 155000, unit: 'тонна', cat: 'ugolok-nerav', bonus: 5, comp: 'Ст3' },
    { name: 'Уголок неравноп. 75x50x6', desc: 'Уголок стальной неравнополочный 75x50x6мм, ГОСТ 8510-93, длина 12м', price: 153000, unit: 'тонна', cat: 'ugolok-nerav', bonus: 5, comp: 'Ст3' },
    { name: 'Уголок неравноп. 100x63x8', desc: 'Уголок стальной неравнополочный 100x63x8мм, ГОСТ 8510-93, длина 12м', price: 150000, unit: 'тонна', cat: 'ugolok-nerav', bonus: 5, comp: 'Ст3' },
    { name: 'Уголок неравноп. 125x80x10', desc: 'Уголок стальной неравнополочный 125x80x10мм, ГОСТ 8510-93, длина 12м', price: 148000, unit: 'тонна', cat: 'ugolok-nerav', bonus: 5, comp: 'Ст3' },
    { name: 'Уголок неравноп. 140x90x10', desc: 'Уголок стальной неравнополочный 140x90x10мм, ГОСТ 8510-93, длина 12м', price: 147000, unit: 'тонна', cat: 'ugolok-nerav', bonus: 5, comp: 'Ст3' },
    { name: 'Уголок неравноп. 160x100x12', desc: 'Уголок стальной неравнополочный 160x100x12мм, ГОСТ 8510-93, длина 12м', price: 146000, unit: 'тонна', cat: 'ugolok-nerav', bonus: 5, comp: 'Ст3' },

    // ─── Лист нержавеющий (AISI 430 / 410) ──────────────────
    { name: 'Лист нерж. 0.5мм AISI 410', desc: 'Лист нержавеющий 0.5мм, 1250x2500, AISI 410 SB+PVC, марка 12Х13', price: 420000, unit: 'тонна', cat: 'nerzh-list', bonus: 4, comp: 'AISI 410 (12Х13)' },
    { name: 'Лист нерж. 0.5мм AISI 430', desc: 'Лист нержавеющий 0.5мм, 1250x2500, AISI 430 SB+PVC, марка 12Х17', price: 410000, unit: 'тонна', cat: 'nerzh-list', bonus: 4, comp: 'AISI 430 (12Х17)' },
    { name: 'Лист нерж. 0.7мм AISI 430', desc: 'Лист нержавеющий 0.7мм, 1250x2500, AISI 430 SB+PVC, марка 12Х17', price: 405000, unit: 'тонна', cat: 'nerzh-list', bonus: 4, comp: 'AISI 430 (12Х17)' },
    { name: 'Лист нерж. 0.8мм AISI 430', desc: 'Лист нержавеющий 0.8мм, 1250x2500, AISI 430 SB+PVC, марка 12Х17', price: 400000, unit: 'тонна', cat: 'nerzh-list', bonus: 4, comp: 'AISI 430 (12Х17)' },
    { name: 'Лист нерж. 1.0мм AISI 430', desc: 'Лист нержавеющий 1.0мм, 1250x2500, AISI 430 SB+PVC, марка 12Х17', price: 395000, unit: 'тонна', cat: 'nerzh-list', bonus: 4, comp: 'AISI 430 (12Х17)' },
    { name: 'Лист нерж. 1.5мм AISI 430', desc: 'Лист нержавеющий 1.5мм, 1250x2500, AISI 430 SB+PVC, марка 12Х17', price: 390000, unit: 'тонна', cat: 'nerzh-list', bonus: 4, comp: 'AISI 430 (12Х17)' },

    // ─── Труба нержавеющая (ГОСТ 9941-81) ────────────────────
    { name: 'Труба нерж. 16x1.0 AISI 201', desc: 'Труба нержавеющая 16x1.0мм, AISI 201, зеркальная, ГОСТ 9941-81', price: 480000, unit: 'тонна', cat: 'nerzh-truba', bonus: 4, comp: 'AISI 201' },
    { name: 'Труба нерж. 18x1.35 AISI 201', desc: 'Труба нержавеющая 18x1.35мм, AISI 201, зеркальная, ГОСТ 9941-81', price: 475000, unit: 'тонна', cat: 'nerzh-truba', bonus: 4, comp: 'AISI 201' },
    { name: 'Труба нерж. 38x1.5 AISI 201', desc: 'Труба нержавеющая 38x1.5мм, AISI 201, зеркальная, ГОСТ 9941-81', price: 470000, unit: 'тонна', cat: 'nerzh-truba', bonus: 4, comp: 'AISI 201' },
    { name: 'Труба нерж. 50.8x1.1 AISI 201', desc: 'Труба нержавеющая 50.8x1.1мм, AISI 201, зеркальная, ГОСТ 9941-81', price: 468000, unit: 'тонна', cat: 'nerzh-truba', bonus: 4, comp: 'AISI 201' },
    { name: 'Труба нерж. 101.6x1.5 AISI 201', desc: 'Труба нержавеющая 101.6x1.5мм, AISI 201, зеркальная, ГОСТ 9941-81', price: 465000, unit: 'тонна', cat: 'nerzh-truba', bonus: 4, comp: 'AISI 201' },

    // ─── Уголок нержавеющий (ГОСТ 8509-93) ──────────────────
    { name: 'Уголок нерж. 20x20x3 AISI 304', desc: 'Уголок нержавеющий 20x20x3мм, AISI 304, марка 08Х18Н10, ГОСТ 8509-93', price: 520000, unit: 'тонна', cat: 'nerzh-ugolok', bonus: 4, comp: 'AISI 304 (08Х18Н10)' },
    { name: 'Уголок нерж. 40x40x4 AISI 304', desc: 'Уголок нержавеющий 40x40x4мм, AISI 304, марка 08Х18Н10, ГОСТ 8509-93', price: 510000, unit: 'тонна', cat: 'nerzh-ugolok', bonus: 4, comp: 'AISI 304 (08Х18Н10)' },
    { name: 'Уголок нерж. 50x50x5 AISI 304', desc: 'Уголок нержавеющий 50x50x5мм, AISI 304, марка 08Х18Н10, ГОСТ 8509-93', price: 505000, unit: 'тонна', cat: 'nerzh-ugolok', bonus: 4, comp: 'AISI 304 (08Х18Н10)' },

    // ─── Переход (ГОСТ 17378-2001) ──────────────────────────
    { name: 'Переход 57x32', desc: 'Переход стальной концентрический 57x32мм, ГОСТ 17378-2001', price: 650, unit: 'штука', cat: 'perehod', bonus: 5, comp: 'Ст20' },
    { name: 'Переход 76x57', desc: 'Переход стальной концентрический 76x57мм, ГОСТ 17378-2001', price: 950, unit: 'штука', cat: 'perehod', bonus: 5, comp: 'Ст20' },
    { name: 'Переход 89x57', desc: 'Переход стальной концентрический 89x57мм, ГОСТ 17378-2001', price: 1100, unit: 'штука', cat: 'perehod', bonus: 5, comp: 'Ст20' },
    { name: 'Переход 108x76', desc: 'Переход стальной концентрический 108x76мм, ГОСТ 17378-2001', price: 1400, unit: 'штука', cat: 'perehod', bonus: 5, comp: 'Ст20' },
    { name: 'Переход 159x108', desc: 'Переход стальной концентрический 159x108мм, ГОСТ 17378-2001', price: 2200, unit: 'штука', cat: 'perehod', bonus: 5, comp: 'Ст20' },

    // ─── Сэндвич-панели ──────────────────────────────────────
    { name: 'Сэндвич стен. ПСБ 60мм', desc: 'Сэндвич-панель стеновая, пенополистирол 25кг/м3, толщина 60мм, ширина 1000мм, сталь 0.45мм', price: 3200, unit: 'м2', cat: 'sendvich-paneli', bonus: 4 },
    { name: 'Сэндвич стен. ПСБ 100мм', desc: 'Сэндвич-панель стеновая, пенополистирол 25кг/м3, толщина 100мм, ширина 1000мм, сталь 0.45мм', price: 4100, unit: 'м2', cat: 'sendvich-paneli', bonus: 4 },
    { name: 'Сэндвич стен. ПСБ 150мм', desc: 'Сэндвич-панель стеновая, пенополистирол 25кг/м3, толщина 150мм, ширина 1000мм, сталь 0.45мм', price: 5200, unit: 'м2', cat: 'sendvich-paneli', bonus: 4 },
    { name: 'Сэндвич стен. МВ 80мм', desc: 'Сэндвич-панель стеновая, базальтовая минвата 115кг/м3, толщина 80мм, ширина 1000мм, сталь 0.45мм', price: 4800, unit: 'м2', cat: 'sendvich-paneli', bonus: 4 },
    { name: 'Сэндвич стен. МВ 100мм', desc: 'Сэндвич-панель стеновая, базальтовая минвата 115кг/м3, толщина 100мм, ширина 1000мм, сталь 0.45мм', price: 5500, unit: 'м2', cat: 'sendvich-paneli', bonus: 4 },
    { name: 'Сэндвич стен. МВ 150мм', desc: 'Сэндвич-панель стеновая, базальтовая минвата 115кг/м3, толщина 150мм, ширина 1000мм, сталь 0.45мм', price: 6800, unit: 'м2', cat: 'sendvich-paneli', bonus: 4 },
    { name: 'Сэндвич кров. ПСБ 100мм', desc: 'Сэндвич-панель кровельная, пенополистирол 25кг/м3, толщина 100мм, ширина 1000мм, сталь 0.45мм', price: 4300, unit: 'м2', cat: 'sendvich-paneli', bonus: 4 },
    { name: 'Сэндвич кров. МВ 100мм', desc: 'Сэндвич-панель кровельная, базальтовая минвата 115кг/м3, толщина 100мм, ширина 1000мм, сталь 0.45мм', price: 5700, unit: 'м2', cat: 'sendvich-paneli', bonus: 4 },
  ];

  for (const p of products) {
    const cat = savedSubs[p.cat] || savedCats[p.cat];
    if (!cat) { console.log(`  SKIP: no cat ${p.cat}`); continue; }
    await prodRepo2.save(prodRepo2.create({
      name: p.name, description: p.desc, price: p.price, unit: p.unit,
      categoryId: cat.id, bonusType: BonusType.PERCENT, bonusValue: p.bonus,
      bonusMultiplier: p.mult || 1, composition: p.comp,
    }));
  }
